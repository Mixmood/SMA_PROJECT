...
public class JINProjectInitiator extends Agent {
  protected void setup() {
    ...
    try {
      ...
      AgentController initiator = container.createNewAgent("initiator", "examples.JINProject.JINContractNetInitiatorAgent", responderNames);
      initiator.start();
    }
    catch (Exception e) {
